package com.upc.talkiaBackend.security.config;

import com.upc.talkiaBackend.security.filters.JwtRequestFilter;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        .requestMatchers("/authenticate","/api/user", "/api/suscriptionHistory/**","/api/users_exist/**","/api/user_get_id/**").permitAll()
